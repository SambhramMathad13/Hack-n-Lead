<?php 
        if($_SERVER['REQUEST_METHOD']=='POST')
        {
          ...
          $email=$_POST['email'];
            ...
            $s=1;
            $sql="SELECT * FROM `ffformss` WHERE `namee`='$name' && `passwordd`='$pass' && `status`='$s' && `email`='$email'";
            $res=mysqli_query($conn,$sql);
      ...
      <div class="container grid grid--2-col">
        ...
        <div class="login-gradent-box">
          <div class="login-gradent--heading-box">
            <h1 class="login-gradent--heading">
              ...
              &gt; Digital platform for college event <span> Voting.</span>
            </h1>
        ...
        <div class="login-form-box">
          ...
          <p class="login-form-text">
            Please Enter Valid Information to Login Up
          </p>
          <form name="myForm" action="http://localhost/sam/login.php" method="post">
            ...
            <div class="forgot-password-box">
              <a class="link create-acc" href="http://localhost/sam/signup.php"
                >Create account</a
              >
            </div>
          </form>
